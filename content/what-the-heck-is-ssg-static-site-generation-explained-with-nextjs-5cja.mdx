...
canonical_url: https://theanshuman.dev/feed/what-the-heck-is-ssg-static-site-generation-explained-with-nextjs-5cja
---
...
- Marketing websites
- Blogs and documentation, like my own [blog](https://theanshuman.dev/feed)
- Portfolio websites
